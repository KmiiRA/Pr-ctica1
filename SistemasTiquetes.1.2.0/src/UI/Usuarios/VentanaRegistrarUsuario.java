    ...
    public VentanaRegistrarUsuario(){
        ...
        btnRegistrar.addActionListener(e->{
            try{
                ...
                boolean exito=GestionarUsuarios.registrarUsuarioSwing(codigo,nombre,apellido1,apellido2,correo,telefono,password,tipo);
                if(exito){
                    JOptionPane.showMessageDialog(this,"Usuario registrado con éxito.");
                    dispose();
                }else{
                    JOptionPane.showMessageDialog(this,"Ya existe un usuario con ese código.");
                }
            }catch(Exception ex){
