...
// Subclase Tiquete Desarrollo
class TiqueteDesarrollo extends Tiquetes{
    private String versionAfectada;
    private String funcionalidadNueva;

    public TiqueteDesarrollo(int codigo, String descripcion, String estado, int usuarioCreador, int tecnicoAsignado, String versionAfectada, String funcionalidadNueva, String notas){
        super(codigo, descripcion, estado, usuarioCreador, tecnicoAsignado, notas);
        this.versionAfectada = versionAfectada;
        this.funcionalidadNueva = funcionalidadNueva;
    }

    @Override
    public void mostrarInfo(){
        super.mostrarInfo();
        System.out.println("Versión afectada: " + versionAfectada);
        System.out.println("Nueva funcionalidad: " + funcionalidadNueva);
    }

    @Override
    public String toString(){
        return super.toString() + ", Versión afectada: " + versionAfectada + ", Nueva funcionalidad: " + funcionalidadNueva;
    }
}
