...
public class Usuarios{
    ...
    public Usuarios(int codigo,String nombre,String primerApellido,String segundoApellido,String correoElectronico,String telefono,String password,String tipo){
        this.codigo=codigo;
        this.nombre=nombre;
    ...
    public String toString(){
        return "Código: "+codigo+", Nombre: "+nombre+" "+primerApellido+" "+segundoApellido+", Correo: "+correoElectronico+", Teléfono: "+telefono+", Tipo: "+tipo;
    }
...
class Administrador extends Usuarios{
    ...
    public Administrador(int codigo,String nombre,String primerApellido,String segundoApellido,String correoElectronico,String telefono,String password,boolean estado){
        super(codigo,nombre,primerApellido,segundoApellido,correoElectronico,telefono,password,"Administrador");
        this.estado=estado;
    }
...
class Creador extends Usuarios{
    ...
    public Creador(int codigo,String nombre,String primerApellido,String segundoApellido,String correoElectronico,String telefono,String password,String departamento){
        super(codigo,nombre,primerApellido,segundoApellido,correoElectronico,telefono,password,"Creador");
...
class Tecnico extends Usuarios{
    ...
    public Tecnico(int codigo,String nombre,String primerApellido,String segundoApellido,String correoElectronico,String telefono,String password,String rol){
        super(codigo,nombre,primerApellido,segundoApellido,correoElectronico,telefono,password,"Técnico");
        this.rol=rol;
    }
